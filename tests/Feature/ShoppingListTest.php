...
class ShoppingListTest extends TestCase
{
    ...
    public function test_changing_grocerie_item_amount(): void
    {
        ...
        // $latestGrocerie->dd();
        $response = $this->postJson("/shopping-lists/change-grocerie/$latestGrocerie->id", ['amount' => 15]);
    ...
    {
        $latestGrocerie = Grocerie::firstWhere('name', 'TestGrocerie');
        $response = $this->deleteJson("/shopping-lists/delete-grocerie/$latestGrocerie->id");
